...
contract CompromisedChallenge is Test {
    ...
    function test_compromised() public checkSolved {
        address addr1 = vm.addr(
            0x7d15bba26c523683bfc3dc7cdc5d1b8a2744447597cf4da1705cf6c993063744 // found in the challenge description
        );
        address addr2 = vm.addr(
            0x68bd020ad186b647a691c6a5c0c1529f21ecd09dcc45241402ac60ba377c4159 // found in the challenge description
        );
    ...
    function _isSolved() private view {
        assertEq(address(exchange).balance, 0, "Exchange still has ETH");
        assertEq(
            recovery.balance,
            EXCHANGE_INITIAL_ETH_BALANCE,
            "Recovery account does not have the expected ETH balance"
        );
        assertEq(nft.balanceOf(player), 0, "Player still owns an NFT");
        assertEq(
            oracle.getMedianPrice("DVNFT"),
            INITIAL_NFT_PRICE,
            "NFT price has changed"
        );
    }
}
